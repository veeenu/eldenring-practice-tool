...
impl BaseAddresses {
    pub fn with_module_base_addr(self, base: usize) -> BaseAddresses {
        BaseAddresses {
            ...
            func_check_graces: self.func_check_graces + base,
...
impl TryFrom<(u32, u32, u32)> for Version {
    ...
    fn try_from(v: (u32, u32, u32)) -> Result<Self, ()> {
        match v {
            ...
            (2, 6, 0) => Ok(Version::V2_06_0),
            (2, 6, 1) => Ok(Version::V2_06_1),
            (2, 6, 2) => Ok(Version::V2_06_2),
            (2, 7, 0) => Ok(Version::V2_07_0),
            (2, 7, 1) => Ok(Version::V2_07_1),
            (maj, min, patch) => {
...
impl From<Version> for (u32, u32, u32) {
    fn from(v: Version) -> Self {
        match v {
            ...
            Version::V2_06_0 => (2, 6, 0),
            Version::V2_06_1 => (2, 6, 1),
            Version::V2_06_2 => (2, 6, 2),
            Version::V2_07_0 => (2, 7, 0),
            Version::V2_07_1 => (2, 7, 1),
        }
    }
}
...
impl From<Version> for BaseAddresses {
    fn from(v: Version) -> Self {
        match v {
            ...
            Version::V2_06_0 => BASE_ADDRESSES_2_06_0,
            Version::V2_06_1 => BASE_ADDRESSES_2_06_1,
            Version::V2_06_2 => BASE_ADDRESSES_2_06_2,
            Version::V2_07_0 => BASE_ADDRESSES_2_07_0,
            Version::V2_07_1 => BASE_ADDRESSES_2_07_1,
        }
    }
}
...
pub const BASE_ADDRESSES_2_06_0: BaseAddresses = BaseAddresses {
    ...
    world_chr_man_dbg: 0x3d66198,
    world_chr_man_imp: 0x3d65f88,
    func_item_spawn: 0x55ac60,
    func_item_inject: 0x560670,
    func_remove_intro_screens: 0xb0c3ed,
    func_dbg_action_force: 0x53c8d5,
    lua_warp: 0x599cce,
    current_target: 0x71737e,
    func_check_graces: 0x3d6cfc0,
    base_fps: 0x3d76060,
    base_anim: 0x3b12e30,
    dbg_event_man_off: 0x3d67ff8,
...
pub const BASE_ADDRESSES_2_06_1: BaseAddresses = BaseAddresses {
    bullet_man: 0x3d62748,
    chr_dbg_flags: 0x3d6619f,
    csfd4_virtual_memory_flag: 0x3d68448,
    cs_flipper: 0x4589ad8,
    ...
    func_item_spawn: 0x55ac60,
    func_item_inject: 0x560670,
    func_remove_intro_screens: 0xb0c44d,
    func_dbg_action_force: 0x5bed8c0,
    lua_warp: 0x599cce,
    current_target: 0x71737e,
    func_check_graces: 0x3d6cfc0,
    base_fps: 0x3d76060,
    base_anim: 0x3b12e30,
    dbg_event_man_off: 0x3d67ff8,
    event_patch1: 0xe53630,
    event_patch2: 0xe53610,
    font_patch: 0x268d390,
    sound_draw_patch: 0x33e596,
    targeting_debug_draw: 0x3d6226b,
};

pub const BASE_ADDRESSES_2_06_2: BaseAddresses = BaseAddresses {
    bullet_man: 0x3d62748,
    chr_dbg_flags: 0x3d6619f,
    csfd4_virtual_memory_flag: 0x3d68448,
    cs_flipper: 0x4589ad8,
    cs_lua_event_manager: 0x3d67e48,
    cs_menu_man: 0x8ba7b534,
    cs_menu_man_imp: 0x3d6b7b0,
    cs_net_man: 0x3d5ae60,
    cs_regulation_manager: 0x3d86c58,
    cs_session_manager: 0x3d7a4d0,
    ...
    world_chr_man_dbg: 0x3d66198,
    world_chr_man_imp: 0x3d65f88,
    func_item_spawn: 0x55aba0,
    func_item_inject: 0x5605b0,
    func_remove_intro_screens: 0xb0c35d,
    func_dbg_action_force: 0x5c7defe,
    lua_warp: 0x599c0e,
    current_target: 0x71727e,
    func_check_graces: 0x3d6cfc0,
    base_fps: 0x3d76060,
    base_anim: 0x3b12e30,
    dbg_event_man_off: 0x3d67ff8,
    event_patch1: 0xe53580,
    event_patch2: 0xe53560,
    font_patch: 0x268d3a0,
    sound_draw_patch: 0x33e476,
    targeting_debug_draw: 0x3d6226b,
};

pub const BASE_ADDRESSES_2_07_0: BaseAddresses = BaseAddresses {
    bullet_man: 0x3d667a8,
    chr_dbg_flags: 0x3d6a20f,
    csfd4_virtual_memory_flag: 0x3d6c4b8,
    cs_flipper: 0x458db58,
    cs_lua_event_manager: 0x3d6beb8,
    cs_menu_man: 0x8ba7c384,
    cs_menu_man_imp: 0x3d6f820,
    cs_net_man: 0x3d5eec0,
    cs_regulation_manager: 0x3d8acd8,
    cs_session_manager: 0x3d7e540,
    damage_ctrl: 0x3d6a3e8,
    field_area: 0x3d6d248,
    game_data_man: 0x3d61f98,
    game_man: 0x3d6d988,
    global_pos: 0x3d69ff8,
    group_mask: 0x3b37d0f,
    hit_ins: 0x3d6e150,
    hit_ins_hitbox_offset: 0x3d6e15c,
    map_item_man: 0x3d6bac0,
    msg_repository: 0x3d81568,
    solo_param_repository: 0x3d85f58,
    world_chr_man: 0x3d69ff8,
    world_chr_man_dbg: 0x3d6a208,
    world_chr_man_imp: 0x3d69ff8,
    func_item_spawn: 0x55b9f0,
    func_item_inject: 0x561400,
    func_remove_intro_screens: 0xb0d9fd,
    func_dbg_action_force: 0x5a85a0d,
    lua_warp: 0x59aa5e,
    current_target: 0x7180ce,
    func_check_graces: 0x3d71030,
    base_fps: 0x3d7a0d0,
    base_anim: 0x3b16e30,
    dbg_event_man_off: 0x3d6c068,
    event_patch1: 0xe55380,
    event_patch2: 0xe55360,
    font_patch: 0x268fbb0,
    sound_draw_patch: 0x33e486,
    targeting_debug_draw: 0x3d662c9,
};

pub const BASE_ADDRESSES_2_07_1: BaseAddresses = BaseAddresses {
    bullet_man: 0x3d667a8,
    chr_dbg_flags: 0x3d6a20f,
    csfd4_virtual_memory_flag: 0x3d6c4b8,
    cs_flipper: 0x458db58,
    ...
    func_item_spawn: 0x55b9f0,
    func_item_inject: 0x561400,
    func_remove_intro_screens: 0xb0da6d,
    func_dbg_action_force: 0x103b59b,
    lua_warp: 0x59aa5e,
    current_target: 0x7180ce,
    func_check_graces: 0x3d71030,
    base_fps: 0x3d7a0d0,
    base_anim: 0x3b16e30,
    dbg_event_man_off: 0x3d6c068,
    event_patch1: 0xe553f0,
    event_patch2: 0xe553d0,
    font_patch: 0x268fc20,
    sound_draw_patch: 0x33e486,
    targeting_debug_draw: 0x3d662c9,
};
